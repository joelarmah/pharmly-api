...
- **No AI attribution in commits, PRs, or code comments.** No "Generated with Codex/Claude/[tool]" footers, no `Co-Authored-By` trailers for an AI, no comments narrating that an AI wrote something. Write commit messages and PR descriptions as plain, direct descriptions of the change.
